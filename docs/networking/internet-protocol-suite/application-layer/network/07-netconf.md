...
* **Operations layer:** Defines a set of base protocol operations to retrieve and edit the configuration data.
* **Messages layer:** Provides a mechanism for encoding remote procedure calls (RPCs) and notifications.
* **Secure Transport layer:** Provides a secure and reliable transport of messages between a client and a server.
